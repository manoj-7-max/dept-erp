...
export default function InchargeInternalMarks1() {
    return (
        <div className="p-8 bg-gray-50 min-h-screen font-sans">
            <div className="flex justify-between items-center mb-10">
                <div>
                    <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight text-indigo-800">Internal Marks - IAT 1</h1>
                    <p className="text-gray-500 mt-1 font-medium text-sm">Official IAT-1 marks recording for your class</p>
                </div>
            </div>
                ...
                <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between">
                        <div>
                            ...
                            <h3 className="text-2xl font-black text-gray-900">72.5 / 100</h3>
                        </div>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between">
                        <div>
                            ...
                            <h3 className="text-2xl font-black text-green-600">88%</h3>
                        </div>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between">
                        <div>
                            ...
                            <h3 className="text-2xl font-black text-red-600">07 Students</h3>
                        </div>
